...
<html lang="en">
<head>
<title>My Info a Personal Category Bootstrap Responsive Website Template | Home :: w3layouts </title>
...
<div class="work" id="work">
	<div class="container">
		...
		<div class="work-info-agileits">
			<div class="col-md-4 work-left-agileits-w3layouts">
				<h6><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 2011-2013</h6>
			</div>
			<div class="col-md-8 work-right-w3-agileits">
		...
		<div class="work-info-agileits">
			<div class="col-md-4 work-left-agileits-w3layouts">
				<h6><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 2008-2011</h6>
			</div>
			<div class="col-md-8 work-right-w3-agileits">
 ...
 <div class="container">
	...
	<div class="col-md-4 contact-grids contact-mid">
		...
		<ul>
			...
			<li><i class="fa fa-map-marker" aria-hidden="true"></i>Jackson, 538, USA</li>
